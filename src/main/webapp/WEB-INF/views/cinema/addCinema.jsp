	                ...
	                <div class="col-lg-12">
	                    <div class="panel panel-primary">
	                        <div class="panel-heading">
	                            <spring:message code="cinema.new" />
	                        </div>
	     
	                <!-- /.row -->
	                <div class="panel-body">
							<!-- /.panel-heading -->
						    <c:url value="/cinema/save" var ="urlSave" />
							<f:form modelAttribute="cinema" action="${urlSave}" role="form" >
								<f:hidden path="numCine"/>
								...
								<div class="form-group">
					 			...
					 			<div class="panel-footer">
					                   		...
					                   		<a href="<c:url value="/cinema/" />" class="btn btn-danger"> <i class="fa fa-arrow-left">&nbsp;<spring:message code="common.quit" /></i></a>
					                	</div>
								</f:form>	                        
	                   		</div>
	                        <!-- /.panel-body -->
