      ...
      <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
					...
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/individual/new" />" class="btn btn-success" ><i class="fa fa-plus">&nbsp;<spring:message code="common.add" /></i></a></li>
						</ol>					
					</div>                
                </div>          
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <spring:message code="individual.list" />
                        </div>
                        <!-- /.panel-heading -->
                   ...
                   <tr class="odd gradeX">
	                                        ...
	                                        <td>${ind.getSurname() }</td>
	                                         <td>
	                                         	...
	                                         	<c:url value="/individual/update/${ind.getNumInd()}" var="urlUpdate" />
	                                        	<a href="${urlUpdate}" class="btn btn-info"><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalIndividual${ind.getNumInd() }" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalIndividual${ind.getNumInd() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																<spring:message code="individual.confirm.suppression.msg" />
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-default" data-dismiss="modal"><spring:message code="common.close" /></button>
																<c:url value="/individual/delete/${ind.getNumInd() }" var="urlDelete" />
